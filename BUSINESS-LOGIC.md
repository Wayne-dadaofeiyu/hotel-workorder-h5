...
**模拟新订单**：
- 每 30 秒有 50% 概率自动生成一个新工单并弹 Toast 提示
- 可以手动点 "Simulate New Order" 按钮即时生成
...
| 1205 房 | 固定 1 送物 + 1 打扫，1-5 分钟前 |
| 其他送物 | 从 34 间房中随机 3-6 间，各生成 1 条，3-40 分钟前 |
| 其他打扫 | 重新随机 3-6 间房，各生成 1 条，3-40 分钟前 |
| 排序 | 1205 房置顶 → 其他按时间倒序 |
| 总数量 | 8-14 条 |
